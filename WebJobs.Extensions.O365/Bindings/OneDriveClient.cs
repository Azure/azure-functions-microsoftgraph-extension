...
namespace Microsoft.Azure.WebJobs.Extensions.MicrosoftGraph
{
    ...
    internal static class OneDriveClient
    {
        ...
        /// <returns></returns>
        public static async Task<byte[]> GetOneDriveContentsAsync(this IGraphServiceClient client, OneDriveAttribute attr)
        {
        ...
        public static async Task<Stream> GetOneDriveContentStreamAsync(this IGraphServiceClient client, OneDriveAttribute attr)
        {
            // Retrieve stream of OneDrive item
            return await client
                .Me
        ...
        public static async Task<DriveItem> GetOneDriveContentDriveItemAsync(this IGraphServiceClient client, OneDriveAttribute attr)
        {
        ...
        public static async Task<DriveItem> UploadOneDriveItemAsync(this IGraphServiceClient graphClient, OneDriveAttribute attr, Stream fileStream)
        {
        ...
        public static async Task<DriveItem> UploadOneDriveItemAsync(this IGraphServiceClient graphClient, OneDriveAttribute attr, byte[] byteArray)
        {
